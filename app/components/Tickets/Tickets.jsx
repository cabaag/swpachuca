...
import '../../assets/imgs/community.jpg';
      ...
      <div>
            ...
            <div className='row center-xs middle-xs'>
              ...
              <div className='col-xs-12 col-lg-6'>
                <div style={{ width: '100%', textAlign: 'left'}}>
                  ...
                  frameBorder="0" height="950px" width="100%" marginHeight="5" marginWidth="5" scrolling="auto" allowTransparency="true"></iframe>
        ...
        <section className={styles.staff}>
          <div className={styles.background}>
            <img src="../../assets/imgs/community.jpg" />
          </div>
          ...
          <div className={'container-fluid ' + styles.container}>
            <div className="row center-xs middle-xs">
              ...
              <div className={'col-xs-12 col-sm-10 col-md-8 col-lg-6 ' + styles.subtitle}>
                Únete al equipo de colaboradores del evento y ayudanos a que sea
